...
public class Almacen_Configuracion implements Serializable {
   ...
   //METODOS SET DE LAS VARIABLES
    ...
    //METODOS GET DE LAS VARIABLES
    public ArrayList<String> getPalabras_partida1() {
        return palabras_partida1;
    }
    
    //METODOS SET DE LAS VARIABLES
    public void setPalabras_partida1(ArrayList<String> palabras_partida1) {
        this.palabras_partida1 = palabras_partida1;
    }
    
    //METODOS GET DE LAS VARIABLES
    public ArrayList<String> getPalabras_partida2() {
        return palabras_partida2;
    }
